...
$lpCl = new Env_ListPoints(array("user" => 'melispot', "pass" => 'Mafate2012', "key" => 'xjwxgnux'));
$lpCl->setEnv('test');
$params = array('srv_code' => 'ColissimoExpert', "collecte"=> "exp", 'pays' => 'FR', 'cp' => '31500', 'ville' => 'TOULOUSE');
