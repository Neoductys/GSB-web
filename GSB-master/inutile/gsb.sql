...
--
-- Client: 127.0.0.1
-- Généré le : Jeu 28 Mars 2013 à 16:43
...
ALTER TABLE `lignefraishorsforfait`
  ADD CONSTRAINT `fk_fichefrais` FOREIGN KEY (`idVisiteur`) REFERENCES `fichefrais` (`idVisiteur`),
  ADD CONSTRAINT `fk_rrmois` FOREIGN KEY (`idVisiteur`, `mois`) REFERENCES `fichefrais` (`idVisiteur`, `mois`),
