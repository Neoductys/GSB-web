...
INSERT INTO `users` (`id`, `nom`, `prenom`, `login`, `mdp`, `adresse`, `cp`, `ville`, `dateEmbauche`, `status`) VALUES
...
('aaa', 'Benabar', 'Octave', 'test', 'btssio', 'Mondran', '31000', 'Toulouse', '2012-10-22', '2');
...
CREATE TABLE IF NOT EXISTS `fichefrais` (
  ...
  `montantSaisie` decimal(5,2) DEFAULT NULL,
...
INSERT INTO `fichefrais` (`id`, `idVisiteur`, `mois`, `nbJustificatifs`, `montantValide`, `dateModif`, `idEtat`, `idCptResp`) VALUES
('001', 'b34', 5, NULL, NULL, NULL, 'CR', NULL);
-- --------------------------------------------------------
...
ALTER TABLE `fichefrais`
  ADD CONSTRAINT `fk_cpt` FOREIGN KEY (`idCptResp`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `fichefrais_ibfk_1` FOREIGN KEY (`idEtat`) REFERENCES `etat` (`id`),
  ADD CONSTRAINT `fichefrais_ibfk_2` FOREIGN KEY (`idVisiteur`) REFERENCES `users` (`id`);

--
-- Contraintes pour la table `lignefraisforfait`
--
ALTER TABLE `lignefraisforfait`
  ADD CONSTRAINT `fk_mois` FOREIGN KEY (`idVisiteur`, `mois`) REFERENCES `fichefrais` (`idVisiteur`, `mois`),
  ADD CONSTRAINT `fk_fichefraisligne` FOREIGN KEY (`idVisiteur`) REFERENCES `fichefrais` (`idVisiteur`),
  ADD CONSTRAINT `lignefraisforfait_ibfk` FOREIGN KEY (`idVisiteur`, `mois`) REFERENCES `fichefrais` (`idVisiteur`, `mois`);
